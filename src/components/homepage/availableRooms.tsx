  ...
  return (
    <div className="bg-white p-6 md:p-10 rounded-3xl drop-shadow-[0_-4px_10px_rgba(0,0,0,0.1)] mx-4 md:mx-20 mt-1 mb-10">
      <div className="flex flex-col md:flex-row justify-between items-start md:items-center gap-4 mb-6">
        <h2 className="text-xl sm:text-2xl md:text-2xl font-bold font-raleway text-black">Find Available Rooms</h2>
      </div>
      ...
      {hasSearched && showEmptyState && (
        <div className="flex flex-col items-center justify-center py-10 sm:py-16 text-gray-500 bg-gray-50 rounded-xl">
          ...
          <p className="text-base sm:text-lg text-center px-4">No rooms found matching your search criteria</p>
      ...
      {hasSearched && !showEmptyState && (
        <>
          <h3 className="text-lg sm:text-xl font-semibold font-raleway mb-4 mt-6 text-black">Available Rooms</h3>
          ...
          <div className="space-y-4 py-2">
            ...
            <div className="space-y-2">
              ...
              <Textarea
                ...
                className="h-24 sm:h-32 text-black text-sm border-black"
              />
            </div>
          </div>

          <DialogFooter className="flex flex-col-reverse sm:flex-row justify-between items-center gap-3 pt-2">
            <Button variant="outline" onClick={() => setShowDialog(false)} className="border-black w-full sm:w-auto">
              Cancel
            </Button>
            <Button
